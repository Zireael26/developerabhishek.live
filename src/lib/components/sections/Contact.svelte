...
<section id="contact" class="dark:bg-secondary-900 bg-white py-20">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			...
			<div>
				<Card>
					...
					<form onsubmit={handleSubmit} class="space-y-6">
						...
						<!-- Submit Button -->
						<Button type="submit" size="lg" disabled={isSubmitting} class="group w-full">
							{#if isSubmitting}
								<div
		...
		<div class="mt-16 text-center">
			<p class="text-secondary-600 dark:text-secondary-400 mb-6">Prefer a more direct approach?</p>
			<div class="flex flex-col justify-center gap-4 sm:flex-row">
				<Button href="mailto:{contactInfo.email}" variant="outline" size="lg" class="group">
					<Mail class="mr-2 h-5 w-5" />
					Email Me Directly
				</Button>
				<Button href={personalInfo.resumeUrl} variant="outline" size="lg" class="group">
					Download Resume
				</Button>
			</div>
		</div>
